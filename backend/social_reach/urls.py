...
urlpatterns = [
    ...
    url(r'^profiles/(?P<username>[\w\-]+)/minage=(?P<min_age>\d+)/maxage=(?P<max_age>\d+)/maxdistance=(?P<max_distance>\d+)/$', views.ProfilesWithinAgeRange.as_view(), name='profiles_in_age_range'),
